...
class ViewModel: ObservableObject {
    ...
    func updateData(todoToUpdate: Todo) {
        ...
        db.collection("admin").document(todoToUpdate.id).setData(["name":"Updated: \(todoToUpdate.name)"], merge: true) { error in
    ...
    func deleteData(todoToDelete: Todo) {
        ...
        db.collection("admin").document(todoToDelete.id).delete { error in
    ...
    func addData(name: String, notes: String) {
        ...
        db.collection("admin").addDocument(data: ["name":name, "notes":notes]) { error in
